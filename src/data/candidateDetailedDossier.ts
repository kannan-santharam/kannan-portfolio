/**
 * MASTER CANDIDATE & CODEBASE KNOWLEDGE BASE FOR AI ASSISTANT
 * ============================================================================
 * KANNAN APPIYA SANTHARAM: Extended master profile containing full career
 * details, metrics, technical skills, work history, portfolio architecture,
 * AI capabilities, governance experience, and Dubai relocation readiness.
 * ============================================================================
 */
